    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Côté Design</h2>
        </div>
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Adobe Lightroom</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Adobe Indesign</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
      ...
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Côté Développement</h2>
        </div>
